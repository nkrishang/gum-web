...
function Phone() {
  return (
    <div
      style={{ height: PANEL_HEIGHT }}
      className="mx-auto w-[236px] overflow-hidden rounded-[30px] border-[5px] border-gum-black bg-gum-white text-gum-black shadow-[0_24px_60px_-36px_rgb(18_18_18/0.6)]"
    >
...
function Embedded() {
  ...
  return (
    <div style={{ height: PANEL_HEIGHT }} className="overflow-hidden rounded-[18px] bg-gum-black p-3">
      <Stage
        width={APP.width}
        height={APP.height}
        fit="contain"
